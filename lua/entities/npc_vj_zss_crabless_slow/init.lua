...
-----------------------------------------------*/
ENT.Model = "models/vj_zombies/slow_main.mdl" -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
...
ENT.SoundTbl_MeleeAttack = nil -- Don't play any for HL2 Zombie
